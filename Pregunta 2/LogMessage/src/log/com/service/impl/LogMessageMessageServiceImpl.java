...
public class LogMessageMessageServiceImpl implements LogMessageService {
	...
	public void logMessage(String messageText, String outPutType) throws Exception {
		...
		messageText = Constant.MESSAGE_TYPE + Constant.SIMPLE_SPACE_TEXT + DateFormat.getDateInstance(DateFormat.LONG).format(new Date()) + messageText;
		...
		if(outPutType.equals(Constant.LOG_TO_CONSOLE)){
			...
			messageText = messageText+","+Constant.MESSAGE_COD_TYPE;
			logOutPutDAO.writeMessage(messageText);
		}
